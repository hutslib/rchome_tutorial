...
lib = CDLL("/home/hts/RoboCup2019/object_detection/libdarknet.so", RTLD_GLOBAL)
...
class object_detection():
    def __init__(self):
        self.image_path = "/home/hts/RoboCup2019/object_detection/data/waving_detection.jpg"
        self.net = load_net("/home/hts/RoboCup2019/object_detection/cfg/yolov2-voc.cfg", "/home/hts/RoboCup2019/object_detection/weights/waving_detection.weights", 0)
        self.meta = load_meta("/home/hts/RoboCup2019/object_detection/data/voc.data")


    def detect(self, net, meta, image, thresh=.7, hier_thresh=.5, nms=.45):
